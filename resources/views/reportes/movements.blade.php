    ...
    <div class="container">
        ...
        <div class="accordion" id="accordionFilter">
            <div class="card">
                ...
                <form method="POST" action="{{ route('accion.filtro.movimientos') }}" id="collapseFilter" class="collapse card-body" aria-labelledby="headingFilter" data-parent="#accordionFilter">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col form-group text-left">
                            ...
                            <a href="{{ route('vista.reportes.movimientos') }}" class="btn btn-secondary">Eliminar filtros</a>
                            <input type="hidden" value="reportes.movements" name="viewreturn">
                        </div>
                    </div>
                </form>
            </div>
