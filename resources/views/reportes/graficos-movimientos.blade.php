...
{{--                <a class="nav-link text-center text-lg-left" id="v-grafico-dia-tab" data-toggle="pill" href="#v-grafico-dia" role="tab" aria-controls="v-grafico-dia" aria-selected="false">Movimientos por dia</a>--}}
{{--                <a class="nav-link text-center text-lg-left" id="v-grafico-tipo-tab" data-toggle="pill" href="#v-grafico-tipo" role="tab" aria-controls="v-grafico-tipo" aria-selected="false">Segun su tipo</a>--}}
...
{{--                <a class="nav-link text-center text-lg-left" id="v-grafico-producto-tab" data-toggle="pill" href="#v-grafico-producto" role="tab" aria-controls="v-grafico-producto" aria-selected="false">Segun su producto</a>--}}
{{--                <a class="nav-link text-center text-lg-left" id="v-grafico-responsable-tab" data-toggle="pill" href="#v-grafico-responsable" role="tab" aria-controls="v-grafico-responsable" aria-selected="false">Segun su responsable</a>--}}
{{--            </div>--}}
{{--        </div>--}}
...
{{--                    </div>--}}
{{--                </div>--}}
{{--                <div class="tab-pane fade mt-4 mt-lg-0" id="v-grafico-tipo" role="tabpanel" aria-labelledby="v-grafico-tipo-tab">--}}
{{--                    <div style="max-height: 250px">--}}
...
{{--                    <div style="max-height: 250px">--}}
{{--                        <canvas id="familia"></canvas>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--                <div class="tab-pane fade mt-4 mt-lg-0" id="v-grafico-producto" role="tabpanel" aria-labelledby="v-grafico-producto-tab">--}}
{{--                    <div style="max-height: 250px">--}}
{{--                        <canvas id="producto"></canvas>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--                <div class="tab-pane fade mt-4 mt-lg-0" id="v-grafico-responsable" role="tabpanel" aria-labelledby="v-grafico-responsable-tab">--}}
{{--                    <div style="max-height: 250px">--}}
{{--                        <canvas id="responsable"></canvas>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
...
{{--@push('custom-scripts')--}}
{{--    <script>--}}
{{--        let diasCanvas = document.getElementById('dias').getContext('2d');--}}
{{--        let tipoCanvas = document.getElementById('tipo').getContext('2d');--}}
{{--        let familiaCanvas = document.getElementById('familia').getContext('2d');--}}
{{--        let productoCanvas = document.getElementById('producto').getContext('2d');--}}
{{--        let responsableCanvas = document.getElementById('responsable').getContext('2d');--}}

{{--        window.charts = [];--}}

{{--        window.charts.push( new Chart(diasCanvas, {--}}
{{--            type: 'line',--}}
{{--            data: {--}}
{{--                datasets: [{--}}
{{--                    label: 'Movimientos por Dia',--}}
{{--                    data: [],--}}
{{--                    backgroundColor: [--}}
{{--                        'rgba(255, 99, 132, 0.2)',--}}
{{--                        'rgba(54, 162, 235, 0.2)',--}}
